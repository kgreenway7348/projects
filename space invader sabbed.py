...
mc.setBlock(x+8,y+8,35,6,78)
mc.setBlock(x+3,y+7,z,35,6)
mc.setBlock(x+7,y+7,z,35,6)
mc.setBlocks(x+6,y+6,z,x+8,y+6,z,35,6)#This is the main body including the eyes.
...
mc.setBlock(x+2,y+1,z,35,6)
mc.setBlock(x+2,y+2,z,35,6)
mc.setBlock(x+8,y+2,z,35,6)
mc.setBlocks(x+10,y+2,z,35,6)
mc.setBlock(x+3,y+1,z,35,6)
mc.setBlock(y+4,y+1,z,35,6)
